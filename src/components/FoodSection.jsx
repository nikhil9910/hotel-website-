...
import newariImg from "../assets/newarifood.jpg";
import thakaliImg from "../assets/thakalifood.jpg";
import indianImg from "../assets/indianfood.jpeg";
import chineseImg from "../assets/chinesefood.jpg";
  ...
  return (
    <section className="w-full py-16 px-4 md:px-10 lg:px-20 bg-gradient-to-b from-white via-slate-50 to-white">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        >
          Delight in authentic flavors and fresh, locally sourced cuisine at Jee Ri Haveli.
        </motion.p>
      </div>
