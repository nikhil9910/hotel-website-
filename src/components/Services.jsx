...
const experiences = [
  ...
  },
  {
    ...
    image: oldTownImg,
    description: "Step back in time with a visit to magnificent forts, palaces, and historic sites in Jodhpur."
  },
  {
    title: "Elegant Heritage Stays",
    icon: <FaHotel className="text-4xl text-blue-500 mb-3" />,
    image: deluxeRoomImg,
    description: "Unwind in thoughtfully designed rooms that blend modern luxury with royal Rajasthani charm."
  },
