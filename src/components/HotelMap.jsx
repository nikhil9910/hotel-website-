...
const mapImageUrl =
  'https://www.google.com/maps/search/?api=1&query=Jee+Ri+Haveli+Jodhpur+Rajasthan';
  ...
  return (
    <div className="flex flex-col my-8">
      ...
      <div className="flex-grow px-4 sm:px-8 max-w-3xl mx-auto text-center">
        ...
        >
          Experience the perfect blend of royal luxury and heritage at Jee Ri Haveli. Nestled in the historic city of Jodhpur, Rajasthan, we offer world-class hospitality with breathtaking views. Your journey to relaxation and cultural immersion begins here.
        </p>
