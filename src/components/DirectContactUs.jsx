...
const DirectContactUs = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const gmailLink = `https://mail.google.com/mail/?view=cm&fs=1&to=dhulikhelboutiquehotel@gmail.com&su=Direct Contact Request&body=
    ...
    const mailtoLink = `mailto:dhulikhelboutiquehotel@gmail.com?subject=Direct Contact Request&body=
      Name: ${encodeURIComponent(data.name)}
      %0AEmail: ${encodeURIComponent(data.email)}
      %0APhone: ${encodeURIComponent(data.phone)}
      %0AAddress: ${encodeURIComponent(data.address)}
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border-none bg-transparent rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    required
                  />
                </div>
          ...
          <div className="text-white text-center md:text-left flex flex-col justify-center">
            <h1 className="text-4xl font-bold mb-4">Jee Ri Haveli</h1>
            <p className="text-lg leading-relaxed mb-4">
              Discover tranquility and elegance at Jee Ri Haveli. Immerse yourself in breathtaking mountain views, luxurious accommodations, and warm hospitality.
            </p>
            <p className="text-lg leading-relaxed">
              Whether you seek a peaceful retreat, a romantic escape, or an authentic cultural experience, our hotel offers a perfect blend of comfort, nature, and tradition.
            </p>
          </div>
        </div>
      </section>
